    ...
    <MainContainer className={classes.mainContainer}>
      ...
      >
        {i18n.t("contacts.buttons.importSheet")}
         ...
         <CSVLink style={{ textDecoration:'none'}} separator=";" filename={'harmony.csv'} data={contacts.map((contact) => ({ name: contact.name, number: contact.number, email: contact.email }))}>
